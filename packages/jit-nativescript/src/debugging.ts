...
export function stringifyDOM(node: NsNode, depth: number): string {
  throw new Error('Not implemented: stringigyDOM');
...
export function stringifyInstructions(instruction: NsTargetedInstruction, depth: number): string {
  throw new Error('Not implemented: stringifyInstructions');
  // const indent = ' '.repeat(depth);
  // let output = indent;
...
export function stringifyTemplateDefinition(def: PartialCustomElementDefinition, depth: number): string {
  throw new Error('Not implemented: stringifyTemplateDefinition');
  // const indent = ' '.repeat(depth);
  // let output = indent;

  // output += `CustomElementDefinition: ${def.name}\n`;
  // output += stringifyDOM(def.template as NsNode, depth + 1);
